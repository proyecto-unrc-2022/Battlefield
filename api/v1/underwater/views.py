...
from app.daos.underwater.uw_game_dao import has_user, update_game, get_game
from app.daos.underwater.submarine_dao import place_submarine, is_placed
...
def place_submarine():
    ...
    try:
        place_submarine(submarine, x_coord, y_coord, direction)
